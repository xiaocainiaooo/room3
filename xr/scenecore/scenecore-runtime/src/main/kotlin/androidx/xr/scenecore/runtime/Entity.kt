...
public interface Entity : ActivityPose {
     ...
     *
     * @return Current [androidx.xr.runtime.math.Vector3] scale relative to the parent.
     */
     ...
     *
     * @param scale The [androidx.xr.runtime.math.Vector3] scale factor from the parent.
     */
