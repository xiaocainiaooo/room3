...
/**
 * Describes the scenegraph functionality that is required from a
 * [androidx.xr.runtime.internal.JxrRuntime] implementation. It is expected that these functions are
 * only valid while the [androidx.xr.runtime.internal.JxrRuntime] is in a resumed state. This is not
 * intended to be used by applications.
 */
@RestrictTo(RestrictTo.Scope.LIBRARY_GROUP_PREFIX)
public interface JxrPlatformAdapter : JxrRuntime {
