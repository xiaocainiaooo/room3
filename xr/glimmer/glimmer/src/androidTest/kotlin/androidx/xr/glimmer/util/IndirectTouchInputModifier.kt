...
package androidx.xr.glimmer.util
...
/**
 * Create a modifier for testing indirect touch input in this module similar to the one in Compose's
 * ui androidInstrumentationTest. This is NOT meant for production. For production use, use
 * foundation gestures detectors or make your own Modifier.Node implementing
 * [IndirectTouchInputModifierNode], see [IndirectTouchInputNode] below for details.
 *
