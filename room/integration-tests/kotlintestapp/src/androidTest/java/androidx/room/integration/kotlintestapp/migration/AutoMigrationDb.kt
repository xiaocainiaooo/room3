...
abstract class AutoMigrationDb : RoomDatabase() {
    ...
    @Entity
    data class Entity3(@PrimaryKey var id: Int, var name: String) {
        companion object {
    ...
    @Entity(
        foreignKeys =
            [ForeignKey(entity = Entity27::class, parentColumns = ["id27"], childColumns = ["id"])]
    )
    data class Entity9(
        @PrimaryKey var id: Int,
        var name: String,
    ...
    @Entity
    data class Entity14(@PrimaryKey var id: Int, var name: String) {
        companion object {
    ...
    @Entity
    data class Entity15(@PrimaryKey var id: Int, var name: String) {
        companion object {
    ...
    /**
     * Rename Entity20 to ‘Entity20_V2’. Rename the column ‘addedInV1’ to ‘renamedInV2’. Change the
     * primary key of this table to ‘name’. Change the affinity of the column ‘renamedInV2’. Add new
     * column ‘addedInV2’.
     */
    @Entity
    ...
    internal interface AutoMigrationDao {
        @Query("SELECT * from Entity1 ORDER BY id ASC") fun getAllEntity1s(): List<Entity1>
    }
