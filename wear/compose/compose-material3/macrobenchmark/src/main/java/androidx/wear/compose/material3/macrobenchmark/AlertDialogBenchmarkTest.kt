...
import androidx.wear.compose.material3.macrobenchmark.common.AlertDialogBenchmark
...
class AlertDialogBenchmarkTest(private val compilationMode: CompilationMode) {
    ...
    fun start() {
        benchmarkRule.measureRepeated(
            ...
            AlertDialogBenchmark.exercise.invoke(this)
        }
    }
