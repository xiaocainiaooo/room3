...
class SuccessConfirmationBenchmarkTest(private val compilationMode: CompilationMode) {
    ...
    fun start() {
        benchmarkRule.measureRepeated(
            ...
            SuccessConfirmationBenchmark.exercise.invoke(this)
        }
    }

    companion object {
        private const val ACTIVITY = "${PACKAGE_NAME}.SUCCESS_CONFIRMATION_ACTIVITY"
