...
class ConfirmationBenchmarkTest(private val compilationMode: CompilationMode) {
    ...
    fun start() {
        benchmarkRule.measureRepeated(
            ...
            ConfirmationBenchmark.exercise.invoke(this)
        }
    }

    companion object {
        private const val ACTIVITY = "${PACKAGE_NAME}.CONFIRMATION_ACTIVITY"
