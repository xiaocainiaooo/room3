...
class ApiStubParserTest {
            ...
            AnnotatedInterface(
                ...
                methods =
                    listOf(
                        ...
                        Method(
                            name = "getPayload",
                            parameters = listOf(Parameter("request", expectedPayloadRequest.type)),
                        ...
                        Method(
                            name = "processList",
                            parameters = listOf(Parameter("list", Types.list(Types.long))),
                    ...
                    methods =
                        listOf(
                            Method(
                                name = "getMorePayload",
                                parameters =
                                    listOf(Parameter("request", expectedPayloadRequest.type)),
                                returnType = expectedPayloadResponse.type,
                                isSuspend = true,
                            )
                        )
    ...
    fun annotatedInterfaceWithEmptyPackageName_isHandledSafely() {
        ...
        assertThat(compileAndParseApi(source).services)
            .containsExactly(AnnotatedInterface(Type(packageName = "", simpleName = "MySdk")))
    }
    ...
    fun missingAnnotatedInterface_throws() {
        ...
        assertThrows<PrivacySandboxParsingException> { compileAndParseApi(source) }
            .hasMessageThat()
            .contains("Unable to find valid interfaces annotated with @PrivacySandboxService.")
    }
