...
import androidx.privacysandbox.ui.client.compose.test.SandboxedSdkUiTest.Companion.UI_INTENSIVE_TIMEOUT_MS
...
// TODO(b/407545924): Extract this to common test util lib
class TestSandboxedUiAdapter(private val signalOptions: Set<String> = setOf()) :
    ...
    internal fun wasOnConfigChangedCalled(): Boolean {
        return configChangedLatch.await(UI_INTENSIVE_TIMEOUT_MS, TimeUnit.MILLISECONDS)
    }
