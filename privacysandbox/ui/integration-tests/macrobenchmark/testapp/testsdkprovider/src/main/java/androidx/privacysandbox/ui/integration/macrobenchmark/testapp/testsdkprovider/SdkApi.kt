...
import androidx.privacysandbox.ui.integration.macrobenchmark.testapp.mediateesdkprovider.IMediateeSdkApiFactory
import androidx.privacysandbox.ui.integration.macrobenchmark.testapp.sdkproviderutils.NativeAdGenerator
import androidx.privacysandbox.ui.integration.macrobenchmark.testapp.sdkproviderutils.PlayerViewProvider
import androidx.privacysandbox.ui.integration.macrobenchmark.testapp.sdkproviderutils.PlayerViewabilityHandler
...
class SdkApi(private val sdkContext: Context) : ISdkApi {
    ...
    private fun maybeGetSandboxedMediateeSdkApi():
        androidx.privacysandbox.ui.integration.macrobenchmark.testapp.mediateesdkprovider.IMediateeSdkApi? {
