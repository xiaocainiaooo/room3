...
package androidx.privacysandbox.ui.integration.macrobenchmark.testapp.mediateesdkprovider
...
class MediateeSdkApiImpl(private val sdkContext: Context) : IMediateeSdkApi {
    override suspend fun loadAd(
        ...
        return androidx.privacysandbox.ui.integration.macrobenchmark.testapp.sdkproviderutils
            .MediateeSdkApiImpl
