...
@Suppress("unused")
class AutofixUnsafeMethodWithQualifiedClassKotlin {
    /**
     * This method call:
     * - has a receiver of type PrintAttributes.Builder
     * - takes param of type PrintAttributes.MediaSize
     * - has return type PrintAttributes.Builder In the generated fix, all three types should appear
     *   as qualified class names.
     */
    @RequiresApi(19)
