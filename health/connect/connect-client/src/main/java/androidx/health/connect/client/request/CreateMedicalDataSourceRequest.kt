 ...
 *   that points to the source of the data. If a client app supports [app deep linking](
 *   https://developer.android.com/training/app-links/deep-linking)>, this URI would ideally link to
 *   a deeplink representing the data source. The maximum length for the URI is 2000 characters.
