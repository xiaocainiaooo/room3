 ...
 * the same Instance. The receiver type for the property delegate must be an instance of [Context].
 *
...
internal class RxDataStoreSingletonDelegate
internal constructor(
    ...
    @GuardedBy("lock") @Volatile private var INSTANCE: RxDataStore<Preferences>? = null
