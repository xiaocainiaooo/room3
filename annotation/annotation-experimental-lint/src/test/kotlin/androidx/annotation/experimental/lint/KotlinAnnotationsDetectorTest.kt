...
3 errors, 0 warnings
    ...
    companion object {
         ...
         * 3. cp
         *    ../../out/androidx/annotation/annotation-experimental-lint-integration-tests/build/intermediates/javac/debug/classes/sample/kotlin/foo/package-info.class
         *    temp/sample/kotlin/foo/
         * 4. jar -c -f sample.kotlin.foo.package-info.jar -C temp .; openssl base64 <
         *    sample.kotlin.foo.package-info.jar | tr -d '\n' | pbcopy
         * 5. Paste below
