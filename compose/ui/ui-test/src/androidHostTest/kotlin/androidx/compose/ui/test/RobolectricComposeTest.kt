...
class RobolectricComposeTest {
    ...
    @Test
    fun testComposeMainQueueTrampolining() =
        runComposeUiTest(effectContext = StandardTestDispatcher()) {
    ...
    @Test
    fun isDoubleTapFired_dispatchTwoTapsWithPerformTouchInput_assertTrue() =
        runComposeUiTest(effectContext = StandardTestDispatcher()) {
            var composableTouchCount = 0
            var composableTapCount = 0
            var composableDoubleTapCount = 0
     ...
     */
    @Test
    fun isTapFired_dispatchTapWithMotionEvents_assertTrue() =
        runComposeUiTest(effectContext = StandardTestDispatcher()) {
            var composableTouchCount = 0
            var composableTapCount = 0
            var composableDoubleTapCount = 0
    ...
    @Test
    fun isDoubleTapFired_dispatchTwoTapsWithMotionEvents_assertTrue() =
        runComposeUiTest(effectContext = StandardTestDispatcher()) {
            var composableTouchCount = 0
            var composableTapCount = 0
            var composableDoubleTapCount = 0
    ...
    @Test
    fun testInputInjectionIntoClippedItemChangingItsSize() =
        runComposeUiTest(effectContext = StandardTestDispatcher()) {
