...
import androidx.compose.remote.creation.compose.test.util.createBitmap
import androidx.compose.remote.creation.compose.test.util.getCoreDocument
...
class DrawOperationsTest {
    ...
    // TODO(b/444668781): it should not render outside the bounds
