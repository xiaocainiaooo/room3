...
Modifiers    | Role
-------------|-------
LayoutInfo   | contains information about the type of layout
Size         | width and height as fixed dimensions
Width        | width as fixed dimension
Height       | height as fixed dimension
...
Modifiers    | Role
-------------|-------
Background   | Draw a plain color background
Clip         | Add a clipping path
Border       | Draw a border around the component
...
LazyRowColumn           | on demand list layout
