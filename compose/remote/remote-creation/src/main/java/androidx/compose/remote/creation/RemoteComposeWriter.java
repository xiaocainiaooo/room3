...
public class RemoteComposeWriter {
     ...
     * @param ops
     */
    protected void validateOps(@NonNull float[] ops) {
    ...
    /**
     * @param name The String representing the name of the {@link Bitmap}.
