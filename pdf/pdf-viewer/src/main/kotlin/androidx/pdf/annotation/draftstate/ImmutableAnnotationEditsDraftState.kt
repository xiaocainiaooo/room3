...
/**
 * Provides immutable access to the current state of annotation edits.
 *
 * @param edits A map of page numbers to their annotation edits. Each page's edits are a map of
 *   [EditId] to [PdfAnnotationData].
 */
