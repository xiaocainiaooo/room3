...
-if class androidx.appsearch.app.DocumentClassFactoryRegistry {}
-keepnames,allowoptimization @androidx.appsearch.annotation.Document class ** {}

# Keep AppSearchDocumentClassMap name for ServiceLoader
-keepnames,allowoptimization class androidx.appsearch.app.AppSearchDocumentClassMap {}
