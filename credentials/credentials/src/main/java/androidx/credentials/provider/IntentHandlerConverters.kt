...
/**
 * IntentHandlerConverters is a util class for PendingIntentHandler that can be used for tests. It
 * contains methods that convert the intents back into their original credential objects.
 */
...
fun Intent.getCreateCredentialException(): android.credentials.CreateCredentialException? {
    ...
    return getParcelableExtra(key, android.credentials.CreateCredentialException::class.java)
}
...
fun Intent.getGetCredentialException(): android.credentials.GetCredentialException? {
    ...
    return getParcelableExtra(key, android.credentials.GetCredentialException::class.java)
}
...
fun Intent.getGetCredentialResponse(): android.credentials.GetCredentialResponse? {
    ...
    return getParcelableExtra(key, android.credentials.GetCredentialResponse::class.java)
}
...
fun Intent.getCreateCredentialCredentialResponse(): android.credentials.CreateCredentialResponse? {
    ...
    return getParcelableExtra(key, android.credentials.CreateCredentialResponse::class.java)
}
