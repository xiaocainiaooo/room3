...
package androidx.credentials.playservices.controllers.utils
...
class CreatePublicKeyCredentialControllerTestUtils {
    companion object {
         ...
         * that generates the
         * [com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialCreationOptions] we
         * utilize here must be a superset based on the FIDO Implementation, *not* the spec! Then
         * during parsing, further values may have been removed, meaning the JSON formed from
         * [com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialCreationOptions] is a
         * guaranteed subset, never greater than the input json superset.
         */
        ...
        private fun configureDescriptors(
            ...
            if (descriptors != null) {
                for (descriptorJSON in descriptors) {
                    ...
                    descriptorI.put("id", TestUtils.Companion.b64Encode(descriptorJSON.id))
        ...
        private fun configureRpAndUser(
            ...
            userJson.put("id", TestUtils.Companion.b64Encode(userId))
