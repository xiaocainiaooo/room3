...
public class ClearCredentialRegistryConfigurationException(errorMessage: CharSequence? = null) :
    ...
    private companion object {
        const val TYPE_CLEAR_CREDENTIAL_REGISTRY_CONFIGURATION_EXCEPTION =
            "androidx.credentials.provider.registry.TYPE_CLEAR_CREDENTIAL_REGISTRY_CONFIGURATION_EXCEPTION"
    }
}
