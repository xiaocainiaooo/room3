 ...
 *
 * @param setId the id of the selected credential set; the set id is generated by the provider's
 *   matcher (see [RegisterCredentialsRequest.matcher])
 * @param credentials the credentials in this selected credential set; the provider must return all
...
public class SelectedCredentialSet(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return this.setId == other.setId && this.credentials == other.credentials
    }
 ...
 *
 * @param credId the id of the selected credential. For example for a digital credential entry, this
 *   maps to the corresponding entry's [DigitalCredentialEntry.id]
 ...
 */
@RestrictTo(RestrictTo.Scope.LIBRARY)
public class SelectedCredential(public val credId: String, public val metadata: String?) {
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is SelectedCredential) return false
        return this.credId == other.credId && this.metadata == other.metadata
    }

    override fun hashCode(): Int {
        var result = credId.hashCode()
