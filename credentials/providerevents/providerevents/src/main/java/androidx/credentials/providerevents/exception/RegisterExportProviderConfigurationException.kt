...
public class RegisterExportProviderConfigurationException(errorMessage: String? = null) :
    ...
    internal companion object {
        internal const val TYPE_REGISTER_EXPORT_PROVIDER_CONFIGURATION_EXCEPTION: String =
            "androidx.credentials.providerevents.exception.TYPE_REGISTER_EXPORT_PROVIDER_CONFIGURATION_EXCEPTION"
    }
}
