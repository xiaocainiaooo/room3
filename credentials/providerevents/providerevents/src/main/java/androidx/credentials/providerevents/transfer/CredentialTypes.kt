...
public object CredentialTypes {
    ...
    public const val BASIC_AUTH: String = "basic-auth"
    /** A public key credential */
    public const val PUBLIC_KEY: String = "passkey"
     ...
     * Interface (API).
     */
    public const val API_KEY: String = "api-key"
    /** A CreditCard credential contains information about a credit or debit card. */
    public const val CREDIT_CARD: String = "credit-card"
    /**
     ...
     * label or id fields.
     */
    public const val CUSTOM_FIELDS: String = "custom-fields"
    /** A DriversLicense credential contains information about a person’s driver’s license. */
    public const val DRIVERS_LICENSE: String = "drivers-license"
    /**
     ...
     * password.
     */
    public const val GENERATED_PASSWORD: String = "generated-password"
    /**
    ...
    public const val PERSON_NAME: String = "person-name"
    /** An SSHKey credential represents an SSH (Secure Shell) key pair. */
    public const val SSH_KEY: String = "ssh-key"
