...
public fun floatIntMapOf(key1: Float, value1: Int): FloatIntMap =
    MutableFloatIntMap().also { map -> map[key1] = value1 }

/**
 * Returns a new [FloatIntMap] with [key1], and [key2] associated with [value1], and [value2],
 * respectively.
 */
public fun floatIntMapOf(key1: Float, value1: Int, key2: Float, value2: Int): FloatIntMap =
    MutableFloatIntMap().also { map ->
        map[key1] = value1
        map[key2] = value2
    }

/**
 * Returns a new [FloatIntMap] with [key1], [key2], and [key3] associated with [value1], [value2],
...
/**
 * Returns a new [FloatIntMap] with [key1], [key2], [key3], and [key4] associated with [value1],
...
/**
 * Returns a new [FloatIntMap] with [key1], [key2], [key3], [key4], and [key5] associated with
...
public fun mutableFloatIntMapOf(key1: Float, value1: Int): MutableFloatIntMap =
    MutableFloatIntMap().also { map -> map[key1] = value1 }

/**
 * Returns a new [MutableFloatIntMap] with [key1], and [key2] associated with [value1], and
 * [value2], respectively.
 */
...
/**
 * Returns a new [MutableFloatIntMap] with [key1], [key2], and [key3] associated with [value1],
...
/**
 * Returns a new [MutableFloatIntMap] with [key1], [key2], [key3], and [key4] associated with
...
/**
 * Returns a new [MutableFloatIntMap] with [key1], [key2], [key3], [key4], and [key5] associated
 ...
 */
public inline fun buildFloatIntMap(builderAction: MutableFloatIntMap.() -> Unit): FloatIntMap {
 ...
 * provided by [MutableFloatIntMap].
 *
...
/**
 * [MutableFloatIntMap] is a container with a [MutableMap]-like interface for [Float] primitive keys
 ...
 */
public class MutableFloatIntMap(initialCapacity: Int = DefaultScatterCapacity) : FloatIntMap() {
    ...
    /**
     * Trims this [MutableFloatIntMap]'s storage so it is sized appropriately to hold the current
     * mappings.
     *
