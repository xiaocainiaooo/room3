...
public fun <K> emptyObjectIntMap(): ObjectIntMap<K> = EmptyObjectIntMap as ObjectIntMap<K>
...
/**
 * Returns a new [ObjectIntMap] with only [key1], [key2], and [key3] associated with [value1],
...
/**
 * Returns a new [ObjectIntMap] with only [key1], [key2], [key3], [key4], and [key5] associated with
...
/**
 * Returns a new [MutableObjectIntMap] with only [key1], [key2], [key3], and [key4] associated with
 * [value1], [value2], [value3], and [value4], respectively.
 */
public fun <K> mutableObjectIntMapOf(
    key1: K,
 ...
 */
public class MutableObjectIntMap<K>(initialCapacity: Int = DefaultScatterCapacity) :
    ObjectIntMap<K>() {
    ...
    /**
     * Trims this [MutableObjectIntMap]'s storage so it is sized appropriately to hold the current
     * mappings.
     *
