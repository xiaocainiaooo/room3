...
public fun intLongMapOf(key1: Int, value1: Long): IntLongMap =
...
/**
 * Returns a new [IntLongMap] with [key1], [key2], and [key3] associated with [value1], [value2],
...
/**
 * Returns a new [IntLongMap] with [key1], [key2], [key3], and [key4] associated with [value1],
...
/**
 * Returns a new [IntLongMap] with [key1], [key2], [key3], [key4], and [key5] associated with
...
public fun mutableIntLongMapOf(key1: Int, value1: Long): MutableIntLongMap =
    MutableIntLongMap().also { map -> map[key1] = value1 }

/**
 * Returns a new [MutableIntLongMap] with [key1], and [key2] associated with [value1], and [value2],
 * respectively.
 */
...
/**
 * Returns a new [MutableIntLongMap] with [key1], [key2], and [key3] associated with [value1],
...
/**
 * Returns a new [MutableIntLongMap] with [key1], [key2], [key3], and [key4] associated with
...
/**
 * Returns a new [MutableIntLongMap] with [key1], [key2], [key3], [key4], and [key5] associated with
 * [value1], [value2], [value3], [value4], and [value5], respectively.
 */
public fun mutableIntLongMapOf(
    key1: Int,
...
/**
 * [MutableIntLongMap] is a container with a [MutableMap]-like interface for [Int] primitive keys
 ...
 */
public class MutableIntLongMap(initialCapacity: Int = DefaultScatterCapacity) : IntLongMap() {
    ...
    /**
     * Trims this [MutableIntLongMap]'s storage so it is sized appropriately to hold the current
     * mappings.
     *
