...
/**
 * TODO(b/228423246): REMOVE THIS FILE TEMPORARILY COPIED FROM UI-TOOLING UNTIL IT IS NOT AVAILABLE
...
internal object ComposableInvoker {
    ...
    private fun compatibleTypes(
        ...
        methodTypes.size == actualTypes.size &&
            methodTypes
                .mapIndexed { index, clazz -> clazz.isAssignableFrom(actualTypes[index]) }
                .all { it }
