...
public class GPUPipelineLayout private constructor(public val handle: Long) : AutoCloseable {
    /**
     * Sets a debug label for the pipeline layout.
     *
     * @param label The label to assign to the pipeline layout.
     */
    @FastNative @JvmName("setLabel") public external fun setLabel(label: String): Unit

    external override fun close()

    override fun equals(other: Any?): Boolean = other is GPUPipelineLayout && other.handle == handle
