...
class SurfaceTest {
    ...
    /**
     * Tests the basic surface lifecycle. This test verifies that a surface can be successfully:
    ...
    /**
     * Verifies that configuring a surface with invalid parameters (e.g., negative width) results in
     * a validation error.
     */
    @Test
