...
class ComputePassEncoderTest {
    ...
    /**
     * Tests that calling `popDebugGroup` without a matching `pushDebugGroup` results in a
     * validation error.
     */
    @Test
    ...
    /**
     * Tests that a balanced call to `pushDebugGroup` and `popDebugGroup` does NOT result in an
     * error.
     */
    @Test
    ...
    /**
     * Verifies that a valid `dispatchWorkgroups` call with a bound pipeline does not produce a
     * validation error.
     */
    @Test
    ...
    /**
     * Tests that calling `dispatchWorkgroupsIndirect` with a buffer lacking `BufferUsage.Indirect`
    ...
    /**
     * Tests that calling `dispatchWorkgroupsIndirect` with a valid buffer (one with
     * `BufferUsage.Indirect`) does NOT result in an error.
     */
    @Test
    ...
    /**
     * Tests that calling a command (e.g., `dispatchWorkgroups`) *after* `end()` has been called
     * results in a validation error.
     */
    @Test
